...
`,r},A(e){let n=e.textContent||"",r=e.getAttribute("href");return/^https?:/.test(n)&&n===r?n:r?`[${n}](${r})`:n},IMG(e){let n=e.getAttribute("alt")||"",r=e.getAttribute("src");if(!r)throw Error();let i=e.hasAttribute("width")?` width="${l(e.getAttribute("width")||"")}"`:"",a=e.hasAttribute("height")?` height="${l(e.getAttribute("height")||"")}"`:"";return i||a?`<img alt="${l(n)}"${i}${a} src="${l(r)}">`:`![${n}](${r})`},LI(e){let n=e.parentNode;if(!n)throw Error();let r="";if(!function(e){let n=e.childNodes[0],r=e.childNodes[1];return!!n&&e.childNodes.length<3&&("OL"===n.nodeName||"UL"===n.nodeName)&&(!r||r.nodeType===Node.TEXT_NODE&&!(r.textContent||"").trim())}(e))if("OL"===n.nodeName)if(a>0&&!n.previousSibling){let n=i(e)+a+1;r=`${n}\\. `}else r=`${i(e)+1}. `;else r="* ";let l=r.replace(/\S/g," "),o=(e.textContent||"").trim().replace(/^/gm,l),s=document.createElement("pre");return s.textContent=o.replace(l,r),s},OL(e){let n=document.createElement("li");return n.appendChild(document.createElement("br")),e.append(n),e},H1(e){let n=parseInt(e.nodeName.slice(1));return e.prepend(`${Array(n+1).join("#")} `),e},UL:e=>e};o.UL=o.OL;for(let e=2;e<=6;++e)o[`H${e}`]=o.H1;let Quote=class Quote{constructor(){this.selection=window.getSelection(),this.processSelectionText=e=>e}closest(e){let n=this.range.startContainer,r=n instanceof Element?n:n.parentElement;return r?r.closest(e):null}get active(){var e;return((null==(e=this.selection)?void 0:e.rangeCount)||0)>0}get range(){var e;return(null==(e=this.selection)?void 0:e.rangeCount)?this.selection.getRangeAt(0):new Range}set range(e){var n,r;null==(n=this.selection)||n.removeAllRanges(),null==(r=this.selection)||r.addRange(e)}set processSelectionTextFn(e){this.processSelectionText=e}get selectionText(){var e;return this.processSelectionText((null==(e=this.selection)?void 0:e.toString().trim())||"")}get quotedText(){return`> ${this.selectionText.replace(/\n/g,`
> `)}
...
//# sourceMappingURL=vendors-node_modules_github_quote-selection_dist_index_js-node_modules_github_session-resume_-31b9f3-5bb24459a61e.js.map